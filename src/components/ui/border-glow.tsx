...
function parseHSL(hslStr: string): { h: number; s: number; l: number } {
  ...
  if (!match) return { h: 26, s: 40, l: 39 }; // Default to primary-ish
...
export function BorderGlow({
  ...
  return (
    <div
      ...
      className={cn("relative grid isolate border border-white/5", className)}
      style={{
    ...
    >
      ...
      {/* outer glow */}
      <span
        className="z-[1] absolute rounded-[inherit] pointer-events-none"
        style={{
          inset: `-${glowRadius}px`,
