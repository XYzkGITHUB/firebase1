      ...
      <section className="pt-48 pb-32 px-8 max-w-4xl mx-auto">
        ...
        <div className="space-y-12 text-foreground/80 leading-relaxed font-light text-lg">
          <div className="space-y-4">
            ...
            <p>
              Все медиа-ресурсы, изображения, графические материалы и текстовый контент, представленные на данном сайте, являются исключительной интеллектуальной собственностью компании RION.
            </p>
            <p className="font-medium text-foreground">
              Мы строго контролируем использование наших ресурсов. Копирование, воспроизведение или распространение любых материалов сайта без предварительного письменного согласия владельца запрещено.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <p>
              Данный сайт предназначен для ознакомления с продукцией и услугами компании RION. Мы оставляем за собой право изменять информацию о товарах, ценах и условиях доставки без предварительного уведомления.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <p>
              Ваши данные, оставленные через формы обратной связи, используются исключительно для связи с вами и не передаются третьим лицам.
            </p>
          </div>
          
          <div className="pt-16 border-t border-border/20 text-[10px] uppercase tracking-[0.4em] font-bold text-muted-foreground">
            © 2026 RION. All Rights Reserved.
          </div>
        </div>
      </section>
