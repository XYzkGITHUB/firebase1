        ...
        <div className="space-y-12 text-foreground/80 leading-relaxed font-light text-lg">
          <div className="space-y-4">
            ...
            <p className="font-medium text-foreground">
              Все изображения, графические материалы и контент на этом сайте являются собственностью RION. Мы просим не использовать наши материалы в сторонних проектах без предварительного согласования.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <p>
              Информация на сайте носит ознакомительный характер. Мы стремимся предоставлять актуальные данные о товарах и услугах, но оставляем за собой право вносить изменения в любое время.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <p>
              Мы защищаем ваши данные любой ценой. Любая информация, которую вы нам доверяете, находится под надежной защитой, хранится в строгой конфиденциальности и никогда не передается третьим лицам.
            </p>
          </div>
