        ...
        <div className="space-y-12 text-foreground/80 leading-relaxed font-light text-lg">
          <div className="space-y-4">
            ...
            <p className="font-medium text-foreground">
              Все медиа-ресурсы, изображения, графические материалы и контент на этом сайте являются исключительной собственностью RION. Использование наших материалов в любых целях без нашего согласия не допускается.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <p>
              Информация на сайте носит ознакомительный характер. Мы оставляем за собой право обновлять данные о товарах и услугах в любое время.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <p>
              Мы обеспечиваем полную безопасность ваших данных. Любая информация, оставленная вами, хранится в строгой конфиденциальности и не передается третьим лицам.
            </p>
          </div>
